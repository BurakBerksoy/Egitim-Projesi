...
import { FaLanguage, FaRedo, FaChartLine, FaClock, FaChartBar, FaTrophy, FaHeart } from 'react-icons/fa';
...
const difficulties = {
    ...
    questions: [
      {
        ...
        options: ['Merhaba', 'Güle güle', 'Teşekkürler', 'Rica ederim'],
        correctAnswer: 'Merhaba',
        category: 'Temel Kelimeler'
      },
      {
        question: 'Which word means "Good morning"?',
        options: ['İyi akşamlar', 'İyi geceler', 'Günaydın', 'Hoşça kal'],
        correctAnswer: 'Günaydın',
        category: 'Selamlaşma'
      },
      {
        question: 'What is "Thank you" in Turkish?',
        options: ['Rica ederim', 'Teşekkürler', 'Özür dilerim', 'Lütfen'],
      ...
      {
        question: 'What is "Please" in Turkish?',
        options: ['Teşekkürler', 'Rica ederim', 'Lütfen', 'Özür dilerim'],
  ...
  medium: {
    ...
    questions: [
      ...
      {
        question: 'What is "I love you" in Turkish?',
        options: ['Seni seviyorum', 'Seni sevmiyorum', 'Seni tanıyorum', 'Seni bilmiyorum'],
        correctAnswer: 'Seni seviyorum',
        category: 'Duygular'
      },
      {
        question: 'Which word means "Friend"?',
        options: ['Düşman', 'Arkadaş', 'Aile', 'Komşu'],
        correctAnswer: 'Arkadaş',
        category: 'İlişkiler'
      },
      {
        question: 'What is "Good night" in Turkish?',
        options: ['Günaydın', 'İyi akşamlar', 'İyi geceler', 'Hoşça kal'],
        correctAnswer: 'İyi geceler',
        category: 'Selamlaşma'
      }
    ]
  },
  hard: {
    ...
    questions: [
      {
        question: 'What is the meaning of "Wonderful"?',
        options: ['Kötü', 'Harika', 'Sıradan', 'Sıkıcı'],
        correctAnswer: 'Harika',
        category: 'Sıfatlar'
      },
      {
        question: 'Which word means "Adventure"?',
        options: ['Sıkıntı', 'Macera', 'Tehlike', 'Güvenlik'],
        correctAnswer: 'Macera',
        category: 'Aktivite'
      },
      {
        question: 'What is "I understand" in Turkish?',
        options: ['Anlamıyorum', 'Anlıyorum', 'Bilmiyorum', 'Biliyorum'],
        correctAnswer: 'Anlıyorum',
        category: 'Düşünce'
      },
      {
        question: 'Which word means "Experience"?',
        options: ['Teori', 'Deneyim', 'Hayal', 'Gerçek'],
        correctAnswer: 'Deneyim',
        category: 'Kavramlar'
      },
      {
        question: 'What is "Good luck" in Turkish?',
        options: ['İyi şanslar', 'Kötü şans', 'Şans yok', 'Şanslıyım'],
        correctAnswer: 'İyi şanslar',
        category: 'Dilekler'
      }
    ]
  }
        ...
        <div className="max-w-4xl mx-auto px-4 relative">
          ...
          >
            ...
            <p className="text-gray-400 text-xl">
              Zorluk seviyesini seçin ve İngilizce bilgilerinizi test edin
            </p>
          </motion.div>
